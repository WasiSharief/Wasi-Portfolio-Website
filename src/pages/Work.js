export default function Work({ref}) {
  return (
    <div ref={ref} className="WorkSectionDiv">
      <h1>Work</h1>
     <h2> I'm Wasi ulla Sharief, I was born Near KGF and raised in Bengaluru.
          <br></br> I completed my Bacholers in AIIS. I'm a Software Engineer
          with around 4 years of experience working as both an SDET and SDE. I
          ...
          using Selenium and integrating customized AI chatbots into websites
          for enhanced user interaction. I'm certified in Full Stack Development
